...
Revision ID: 054e0527f6ba
Revises: 8d08e3d144ec
Create Date: 2025-02-12 14:44:14.121418
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("work_schedule_id", "reception_point_id"),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("Open_Hours_Point")
